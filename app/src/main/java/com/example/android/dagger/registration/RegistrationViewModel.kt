 ...
 * @Inject tells Dagger how to create instance of type [RegistrationViewModel]
 * Dagger also knows that the parameter of the constructor is a dependency of this type
 */
@ActivityScope
